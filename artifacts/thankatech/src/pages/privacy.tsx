        ...
        <div className="prose prose-slate max-w-none space-y-8 text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-3">
              To exercise any of these rights, email us at <a href="mailto:hello@thankatech.com" className="text-primary underline">hello@thankatech.com</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Questions about this Privacy Policy? Contact us at <a href="mailto:hello@thankatech.com" className="text-primary underline">hello@thankatech.com</a>.
            </p>
          </section>
